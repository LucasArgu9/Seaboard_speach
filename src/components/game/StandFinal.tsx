...
export function StandFinal({ state }: { state: PublicState }) {
  ...
  return (
    <div className="relative grid min-h-dvh place-items-center overflow-hidden p-10">
      {phase === "calc" ? (
        <div className="sb-anim-fade text-center">
        ...
        <div className="sb-anim-fade-up w-full max-w-4xl">
          <Confetti durationMs={7000} />

          {winner && (
            <div className="sb-anim-pop mb-6 rounded-3xl bg-gradient-to-br from-green-500/30 to-navy-500/20 p-8 text-center ring-2 ring-green-400">
            ...
            {ranking.map((r) => (
              ...
              >
                ...
                <span className="ml-auto text-sm text-white/50">
                  {r.correctCount}/{state.totalQuestions} ✓
                </span>
